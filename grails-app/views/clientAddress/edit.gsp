        ...
        <g:form method="post" class="form-horizontal">
            ...
            <div class="well">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <g:textField readonly="true" class="input-xlarge focused" placeholder="Click 'Add' to add a client!" name="clientShow" value="${clientAddressData?.client}" onclick="selectClient()"></g:textField> <a href="javascript:selectClient()"><img src="${request.contextPath}/images/add.jpg"> Add</a> <span class="help-inline">Required</span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <g:textField readonly="true" name="addressShow" placeholder="Click 'Add' to add a contact address!" class="input-xlarge focused" onclick="selectAddress()" value="${clientAddressData?.addr}"></g:textField> <a href="javascript:selectAddress()"><img src="${request.contextPath}/images/add.jpg"> Add</a> <span class="help-inline">Required</span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <g:textField readonly="true" name="addressTypeShow" class="input-xlarge focused" onclick="selectAddressType()" placeholder="Click 'Add' to add a address type!" value="${clientAddressData?.addrType}"></g:textField>  <a href="javascript:selectAddressType()"><img src="${request.contextPath}/images/add.jpg"> Add</a>  <span class="help-inline">Required</span>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <g:checkBox name="activeInd" value="${clientAddressData?.activeInd}"></g:checkBox>
                    </div>
                </div>

                <div class="offset3">
                    <g:actionSubmit name="udpate" action="update"  class="btn btn-primary" onclick="return checkForm();" value="${message(code: 'default.button.update.label', default: 'Updte')}" />
