...
//                }
    ...
    <div class="container-fluid span10">
        <div class="span12 divbk">
            <g:link  action="list"><i class="icon-list"></i><g:message code="default.list.label" args="[entityName]" /></g:link> <a href=# onclick="createProvider();"><i class="icon-plus"></i>New Provider</a>
        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="addressTab">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <g:select name="state" from="${com.bssi.Address.constraints.state.inList}" noSelection="${['':'State']}"></g:select> <span class="help-inline">Required</span>
                    ...
                    <div class="tab-pane" id="contactTab">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <g:textField readonly="true" name="addressShow" placeholder="Click 'Add' to add a contact address!" class="input-xlarge focused" value="${clientContactData?.addr}" onclick="selectAddress()"></g:textField> <a href="javascript:selectAddress()"><img src="${request.contextPath}/images/add.jpg"> Select</a> <span class="help-inline">Required</span>
        ...
        <div id="client_providerdlg" title="Provider"
            ...
            <table>
                ...
                <tr>
                    ...
                    <td> <g:select name="client_prefix" from='${['Title1','Title2']}' value="${providerData?.prefix}" /></td>
                </tr>
                <tr>
    ...
    <div id="contactAddressdlg" title="Contact Address"
         class="easyui-dialog" style="width:700px;height:600px;padding:10px 20px"
         closed="true" buttons="#contactAddressdlg-buttons">
        <h2>${message(code: 'contactAddress.label', default: 'Contact Address')}</h2>

        <hr>
    </div>
    <div id="contactAddressdlg-buttons">
        <a href="#" class="btn btn-primary"  onclick="return saveProvider();">${message(code: 'default.button.save.label', default: 'Save')}</a>
        <a href="#" class="btn"  onclick="closeProvider();">${message(code: 'default.button.cancel.label', default: 'Cancel')}</a>
    </div>
    </div>
