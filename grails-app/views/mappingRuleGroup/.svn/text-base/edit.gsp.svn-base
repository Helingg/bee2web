...
<html>
    ...
    %{--<g:if test="${flash.message}">--}%
        %{--<div class="message span10 offset3" style="color: red">${flash.message}</div>--}%
    %{--</g:if>--}%
                ...
                <div class="well span9">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <g:hiddenField name="fromApplication1" id="fromApplication1" value="${mappingRuleGroupData?.fromApplication.id}"></g:hiddenField>                    </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <g:hiddenField name="toApplication1" id="toApplication1" value="${mappingRuleGroupData?.toApplication.id}"></g:hiddenField> </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <g:checkBox name="activeInd" value="${mappingRuleGroupData?.activeInd}" />
                        </div>
                    </div>
