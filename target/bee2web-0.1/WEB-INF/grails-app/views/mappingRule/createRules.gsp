...
<head>
    ...
    <script>
        ...
        var optionType =[
            ...
            {optionTypeId:'MOV',optionTypeName:'MOV'},
            {optionTypeId:'BLK',optionTypeName:'BLK'}
        ];
...
//                pageList:[10,20,30,40,50,100,500],
                ...
                columns:[[
                    ...
                    {field:'operator',title:'Option',width:90,formatter:function(value){
                        if(value=='BLK'){
                            return 'Blank';
                        }else if(value=='SET'){
                            return  'Set';
                    ...
                    {field:'conditions',title:'Target',width:90},
...
//                }
    ...
    function openTemplateDialog(){
        ...
        var type = document.getElementById('type');
        if(!mappingRuleGroup.value){
            alert("Please select a Mapping Rule Group");
            return false;
        }
    ...
    function optionChange(){
        ...
        if(n=='MOV'){
            if(rowTemp){
                if(rowTemp.conditions){
                    ...
                    var toIndex = document.getElementById('toIndexdlg');
                    var toSubIndex = document.getElementById('toSubIndexdlg');
                    var movCopy = document.getElementById('movCopy');
                    var conditions = rowTemp.conditions;
                    var conditionsArray = conditions.split("|");
                    if(rowTemp.value =="CPY") {
                        movCopy.checked = true;
                        mappingRule_optionCopy.checked = true;
                        mappingRule_optionCopyTr.style.diplay=""
                    }else{
                        movCopy.checked = false;
                        mappingRule_optionCopy.checked = false;
                        mappingRule_optionCopyTr.style.diplay=""
                    }
                    toSegment.value = '';
        ...
        if(n==''){
            ...
            var toSubIndex = document.getElementById('toSubIndexdlg');
            mappingRule_optionCopy.checked = false;
            mappingRule_optionCopyTr.style.diplay="none"
            toSegment.value="";
            toIndex.value="";
            toSubIndex.value ="";
            operatorTemp = "";
...
//                        selectType.checked=true;
    ...
    function updateRule(){
        ...
        if(mappingRule_option.value!="BLK"){
            if(!mappingRule_condition.value&&!mappingRule_value.value) {
                alert("The value is null");
                mappingRule_condition.focus();
                return false;
            }
        }
        ...
        $.ajax({
            ...
            data: {id:mappingRule_id.value,segment:mappingRule_segment.value.toUpperCase(),field:mappingRule_field.value,
                ...
                mappingRuleGroup:mappingRuleGroup.value,type:type.value,value:mappingRule_value.value,copy:mappingRule_optionCopy.checked},
            success: function(text){
...
<div id="mms" class="easyui-menu" style="width:200px;">
    ...
    %{--<div onclick="return removeRule()">Remove Rule</div>--}%
    <div onclick="return removeSegment()">Remove Segment</div>
    <div onclick="return removeSegmentRule();">Remove Rule</div>
    <div onclick="return removeRule()">Clear Rule</div>
</div>
...
<div id="editRule_dlg" title="${message(code:'mappingRule.label', default:'Mapping Rule')}"
     class="easyui-dialog" style="width:550px;height:550px;padding:10px 20px"
    ...
    <table style="line-height: 10px">
        ...
        <tr>
            ...
            <td>
                <g:select onchange="optionChange();" name="mappingRule_option" optionKey="option" optionValue="optionShow" from="${[[option:'SET',optionShow:'Set'],[option:'MOV',optionShow:'Move'],[option:'BLK',optionShow:'Blank']]}"></g:select>
        ...
        <tr id="mappingRule_optionCopyTr" style="display: none">
            <td><label>${message(code: 'mappingRule.copy.label', default: 'Copy')}:</label></td>
            <td><g:checkBox name = "mappingRule_optionCopy" id="mappingRule_optionCopy"></g:checkBox> </td>
        </tr>

        <tr>
            <td><label>${message(code: 'mappingRule.condition.label', default: 'Target')}:</label></td>
            <td>
                <input type="text"  name="mappingRule_condition"  id="mappingRule_condition" onclick="optionChange();" placeholder = "Click to edit" readonly="true">
        ...
        <div class="span3">
            <div class="well sidebar-nav">
                <ul class="nav nav-list">
                    ...
                    <li class="active"><g:link  controller="mappingRule" action="list"><i class="icon-home"></i>Mapping Rule List</g:link></li>
                    <li class="active"><a href="#" onclick="return openTemplateDialog();"><i class="icon-plus"></i>${message(code:'mapingRule.importTemplate.label',default:'Impoort Template')}</a></li>
                    <li class="active"><a  href="#" onclick="return openScripting();"><i class="icon-plus"></i>${message(code:'mapingRule.scripting.label',default:'Scripting')}</a></li>
            ...
            <div class="well span12">
                ...
                <table cellpadding=5px >
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                            <input type="button" class="btn btn-primary" value="Create Rule Group" onclick = "return createMappingRuleGroup('c')">
...
%{---------------------------------------------Rule group option---------------------------------------------------------------------------------------}%
                <div id="rule_ruleGroup_dlg" title="Rule Group"
                  ...
                  <table>
                      ...
                      <tr>
                          <td><label  class="control-label"><g:message code="mappingRuleGroup.activeInd.label" default="Enabled" /></label></td>
