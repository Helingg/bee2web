...
<head>
    ...
    <script type="text/javascript">
        function setTemplate(){
            ...
            var hl7version = document.getElementsByName('hl7version1');
            var segment = document.getElementsByName('segment1');
            var segmentIndex = document.getElementsByName('segmentIndex1');
            var field = document.getElementsByName('field1');
            var fieldIndex = document.getElementsByName('fieldIndex1');
            var subfield = document.getElementsByName('subfield1');
            var subfieldIndex = document.getElementsByName('subfieldIndex1');
            var mandatory = document.getElementsByName('mandatory1');
            var repeatable = document.getElementsByName('repeatable1');
            var required = document.getElementsByName('required1');
            var length = document.getElementsByName('length1');
            var len = tid.length;
            var templateString = ""
            if(len>0){
                for(var i=0;i<len;i++){
                    if(tid[i].checked){
                        templateString = templateString + tid[i].value +":"+type[i].value +":"+hl7version[i].value +":"+segment[i].value +":"+segmentIndex[i].value +":"+field[i].value +":"+fieldIndex[i].value +":"+subfield[i].value +":"+subfieldIndex[i].value +":"+required[i].checked +":"+ repeatable[i].checked +":"+length[i].value +",";
                    }
                }
            }
            parent.window.opener.setTempalteInfo(templateString);
            top.close();
        }
        function test(){
            alert(11);
...
//
        ...
        function checkNum(){
            ...
            if(segmentIndex.value!=""&&segmentIndex.value!=null&&!checknum.exec(segmentIndex.value)){
                ...
                segmentIndex.style.backgroundColor='red';
                segmentIndex.focus();
                return false;
            }
            ...
            if(fieldIndex.value!=""&&fieldIndex.value!=null&&!checknum.exec(fieldIndex.value)){
                ...
                fieldIndex.style.backgroundColor='red';
                fieldIndex.focus();
                return false;
            }
            ...
            if(subfieldIndex.value!=""&&subfieldIndex.value!=null&&!checknum.exec(subfieldIndex.value)){
                ...
                subfieldIndex.style.backgroundColor='red';
                subfieldIndex.focus();
                return false;
            }
            return true;
...
<div class="body">
        ...
        <table>
            ...
            <g:each in="${templateDataList}" status="i" var="templateData">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}" id="tr${i}">
                    <td><g:checkBox name="tid" id="tid" value="${templateData.id}" checked="false" ></g:checkBox></td>

                    <td><g:link action="show" id="${templateData.id}">${fieldValue(bean: templateData, field: "id")}</g:link></td>

                    <td><g:hiddenField  name="type1" value="${templateData?.type}" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData?.type}</td>

                    <td><g:hiddenField  name="hl7version1" value="${templateData?.hl7version}" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData?.hl7version}</td>

                    <td><g:hiddenField  name="segment1" value="${templateData?.segment}" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData?.segment}</td>

                    <td><g:hiddenField  name="segmentIndex1" value="${templateData?.segmentIndex}" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData?.segmentIndex}</td>

                    <td><g:hiddenField  name="field1" value="${templateData?.field}" style="border: none" size="25" readonly="true"></g:hiddenField>${templateData?.field}</td>

                    <td><g:hiddenField  name="fieldIndex1" value="${templateData?.fieldIndex}" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData?.fieldIndex}</td>

                    <td><g:hiddenField  name="subfield1" value="${templateData?.subfield}" style="border: none" size="25" readonly="true"></g:hiddenField>${templateData?.subfield}</td>

                    <td><g:hiddenField  name="subfieldIndex1" value="${templateData?.subfieldIndex}" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData?.subfieldIndex}</td>

                    <td><g:checkBox name="required1" value="${templateData.required}" disabled="true"></g:checkBox></td>

                    <td><g:checkBox name="mandatory1" value="${templateData.mandatory}" disabled="true"></g:checkBox></td>

                    <td><g:checkBox name="repeatable1" value="${templateData.repeatable}" disabled="true"></g:checkBox></td>

                    <td><g:hiddenField  name="length1" value="" style="border: none" size="3" readonly="true"></g:hiddenField>${templateData.length}</td>
                </tr>
            </g:each>
            </tbody>
        </table>
    ...
    <div class="nav">
        <span class="menuButton"><a href="javascript:setTemplate();">OK</a></span>
    </div>
</div>
</body>
</html>
